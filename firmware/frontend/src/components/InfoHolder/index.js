...
const InfoHolder = ({children}) => {
  let statusColour = Children.toArray(children).count >= 1 ? "bg-green-500" : "bg-yellow-500"
  return <div className="absolute z-20 bottom-0 left-5 bg-white w-1/6 rounded-t-2xl">
